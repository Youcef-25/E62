...
function showNotification(message, isError = false) {
    const notifColor = isError ? '#ffcccc' : '#ccffcc';
    notification.style.backgroundColor = notifColor;
    notification.style.border = '1px solid ' + (isError ? '#ff0000' : '#00aa00');
    notification.style.padding = '0.5em';
